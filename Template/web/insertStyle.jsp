          ...
          <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <div class="pt-4 pb-3">
                  <h5 class="card-title text-center pb-0 fs-4">Ajout style</h5>
                  <p class="text-center small">Entrez les informations concerant le style.
                  </p>
                </div>

                <form id="login" class="row g-3 needs-validation" method="post" action="InsertStyle" novalidate>
