 ...
 * @author tahir
 */
@WebServlet(urlPatterns = {"/AjoutTerreInputOnServlet"})
public class AjoutTerreInputOnServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                latitudes.add(Float.parseFloat(request.getParameter("lat"+String.valueOf(i))));
                longitudes.add(Float.parseFloat(request.getParameter("long"+String.valueOf(i))));
            }
