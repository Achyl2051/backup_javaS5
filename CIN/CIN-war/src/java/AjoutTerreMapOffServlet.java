 ...
 * @author tahir
 */
@WebServlet(urlPatterns = {"/AjoutTerreMapOffServlet"})
public class AjoutTerreMapOffServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                double lat = (double) jsonObject.getDouble("lat");
                double lng = (double) jsonObject.getDouble("lng");
                latitudes.add(lat);
                longitudes.add(lng);
            }
